...
class _AllVideosTabState extends State<AllVideosTab> {
  ...
  Widget build(BuildContext context) {
    ...
    var listOrGrid = Provider.of<AllVideosProvider>(
      context,
      listen: true,
    ).listOrGrid;

    videos = Provider.of<AllVideosProvider>(
      context,
      listen: true,
    ).videos;
            ...
            SizedBox(
              ...
              child: Row(
                ...
                children: [
                  ...
                  IconButton(
                    onPressed: () {
                      context.read<AllVideosProvider>().changeListOrGrid();
                    },
                    icon: Icon(
                      listOrGrid! ? Icons.grid_view : FontAwesomeIcons.list,
                      color: Colors.black54,
                    ),
                  ),
                ],
              ...
              child: listOrGrid
                  ...
                  : ReorderableGridView.builder(
                      ...
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                        ...
                        crossAxisSpacing: 10,
                        mainAxisSpacing: 12,
                        childAspectRatio: isLandScape ? 1.52 : 0.66,
                      ),
                      itemBuilder: (_, i) =>
